...
return [
    ...
    'stock_replenishment_min_stock_percent' => [
        ...
        'description' => 'Percent of units sold during the stock replenishment lookback window used as the minimum stock level. Example: 50 means min stock = 50% of total sold in those months.',
        'input' => 'number',
        'type' => 'int',
        'default' => 50,
        'min' => 0,
    ...
    'stock_replenishment_purchase_threshold_percent' => [
        'label' => 'Minimum Stock Purchase Threshold percentage',
        'description' => 'If physical stock is at or below this percent of lookback sales, a purchase order is generated for the product replenishment buy quantity. Example: 25 means generate a PO when stock is 25% or less of units sold in the lookback window.',
        'input' => 'number',
        'type' => 'int',
        'default' => 25,
        'min' => 0,
    ...
    'firm_email' => [
        'label' => 'Firm email',
        'description' => 'Email address of the firm for invoices and documents.',
        'input' => 'text',
        'type' => 'string',
        'default' => '',
        'editable' => true,
    ...
    'firm_phone' => [
        'label' => 'Firm phone',
        'description' => 'Phone number of the firm for invoices and documents.',
        'input' => 'text',
        'type' => 'string',
        'default' => '',
        'editable' => true,
    ...
    'firm_state' => [
        'label' => 'Firm state',
        'description' => 'State of the firm (e.g. Delhi).',
        'input' => 'text',
        'type' => 'string',
        'default' => '',
        'editable' => true,
    ...
    'firm_state_code' => [
        'label' => 'Firm state code',
        'description' => 'State code of the firm (e.g. 07 for Delhi).',
        'input' => 'text',
        'type' => 'string',
        'default' => '',
        'editable' => true,
