                    ...
                    <div class="flex-grow flex">
                        ...
                        <div class="flex-grow grid grid-cols-[80px_10px_1fr] items-baseline gap-y-1 content-start">
                            ...
                            <?php if (!empty($item['publisher'])): ?>
                                <span class="grid-label">Publisher</span> <span class="grid-label">:</span> <span class="grid-value"><?php echo $item['publisher']; ?></span>
                            <?php endif; ?>
                            <?php if (!empty($item['color'])): ?>
                                <span class="grid-label">Color</span> <span class="grid-label">:</span> <span class="grid-value"><?php echo ucfirst($item['color']); ?></span>
                            <?php endif; ?>
                        ...
                        <button class="create-po-btn mb-6 w-36">
                            ...
                            <div class="grid grid-cols-[90px_10px_1fr] w-full gap-y-1">
                                ...
                                <span class="grid-label">shippingfee</span> <span class="grid-label">:</span> <span class="grid-value"><?php echo $item['shippingfee'] ?? 'N/A'; ?></span>
                                <span class="grid-label">sourcingfee</span> <span class="grid-label">:</span> <span class="grid-value"><?php echo $item['sourcingfee'] ?? 'N/A'; ?></span>
                            </div>
                        </div>
