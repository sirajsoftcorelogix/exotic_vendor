  ...
  <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm space-y-4 col-span-2">
    <h3 class="font-semibold text-gray-800 flex items-center gap-2"><i class="fas fa-boxes text-amber-600"></i>Inventory</h3>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-2.5">
        ...
        <div class="flex items-center justify-between border border-amber-100 bg-amber-50/50 rounded-lg p-3 relative" title="Total on-hand stock across all warehouses">
          <div>
            <p class="text-sm text-gray-500">Physical Stock</p>
            <p id="productPhysicalStock" class="text-lg font-semibold leading-tight"><?php echo htmlspecialchars($products['physical_stock'] ?? '0'); ?></p>
          </div>
          <div class="bg-amber-100 text-amber-600 h-8 w-8 rounded-md flex items-center justify-center text-sm">
            <i class="fas fa-warehouse"></i>
          </div>
          <button class="absolute top-0 right-1 text-gray-500 hover:text-amber-600" onclick="openStockModal()" title="Adjust warehouse stock">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
      ...
      <div class="space-y-2.5 text-sm">
        <div class="flex justify-between items-start bg-gradient-to-r from-green-50 to-emerald-50 p-2.5 rounded-lg border border-green-100 relative">
          ...
          <div class="text-right shrink-0" style="margin-right: 5px;">
