                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <div class="flex flex-wrap items-left gap-4">
                        <div class="relative flex items-left gap-2">
                            <input type="text" name="search_text" placeholder="Search by name, email or phone" class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" style="width: 300px; height: 37px; border-radius: 5px;" value="<?php echo $data['search'] ?? '' ?>">
                        </div>
                    </div>
                    <div class="relative">
                        <select style="width: 152px; height: 37px; border-radius: 5px;" class="custom-select bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5" name="role_filter" id="role_filter">
                            ...
                            <?php /*?><option value="manager" <?php echo ($data['role_filter']=="manager") ? "selected" : ""?>>Manager</option>
                            <option value="executive" <?php echo ($data['role_filter']=="executive") ? "selected" : ""?>>Executive</option>
                            <option value="sales" <?php echo ($data['role_filter']=="sales") ? "selected" : ""?>>Sales</option>
                            <option value="data-entry" <?php echo ($data['role_filter']=="data-entry") ? "selected" : ""?>>Data Entry</option><?php */?>
                        </select>
                    </div>
                    <div class="relative">
                        <select style="width: 152px; height: 37px; border-radius: 5px;" class="custom-select bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5" name="status_filter" id="status_filter">
                    ...
                    <div class="relative">
                        <input type="submit" value="Search" style="width: 100px; height: 37px; border-radius: 5px;" class="bg-gray-800 hover:bg-gray-900 text-white font-bold rounded-lg flex items-center justify-center gap-2">
                    </div>
                </div>
            </form>
        </div>
        <!-- Add User Button -->
        <button style="width: 120px; height: 40px; font-family: Inter; font-weight: 500; font-size: 13px; line-height: 100%; letter-spacing: 0%; margin-right:10px;" class="bg-gray-800 hover:bg-gray-900 text-white font-bold rounded-lg flex items-center justify-center gap-2" id="open-vendor-popup-btn">
                ...
                <table class="min-w-full divide-y divide-gray-200">
					...
					?>
                                <tr class="table-content-text">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span style="width: 135px; height: 25px;" class="px-3 py-1 inline-flex items-center justify-center text-xs leading-5 font-semibold rounded-md bg-black text-white"><?= ($item['role']!="") ? ucwords(str_replace("_", " ",$item['role'])) : '' ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                    ...
                    <form id="addUserForm">
                        ...
                        <div class="grid grid-cols-2 gap-x-8 gap-y-4 mb-6">
                            ...
                            <div>
                                ...
                                <select id="role" name="role" class="mt-1 block pl-3 pr-10 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md form-input w-full md:w-[300px]" required>
                            ...
                            <div>
                                ...
                                <select id="is_active" name="is_active" class="mt-1 block pl-3 pr-10 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md form-input w-full md:w-[300px]" required>
...
<!-- Edit User Modal -->
<!-- 🔹 Edit User Modal (ONE only) -->
<div class="modal fade hidden" id="editUserModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <!-- Sliding Container -->
    <div id="modal-slider-edit" class="popup-transition fixed top-0 right-0 h-full flex transform translate-x-full z-50" style="width: calc(45% + 61px); min-width: 661px;">
        <!-- Close Button -->
        <div class="flex-shrink-0 flex items-start pt-5">
                ...
                <div class="p-8">
                    ...
                    <form id="editUserForm">
                        ...
                        <div class="grid grid-cols-2 gap-x-8 gap-y-4 mb-6">
                            ...
                            <div>
                                <label for="role" class="text-sm font-medium text-gray-700">Role:</label>
                                <select id="editRole" name="role" class="mt-1 block pl-3 pr-10 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md form-input w-full md:w-[300px]">
                                    <option value="admin">Admin</option>
                                    <option value="onboarding_executive">Onboarding Executive</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <label for="is_active" class="text-sm font-medium text-gray-700">Active:</label>
                                <select id="editIs_active" name="is_active" class="mt-1 block pl-3 pr-10 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md form-input w-full md:w-[300px]">
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                                </select>
                            </div>
...
<div id="popup-wrapper" class="hidden">
    <!-- Background Overlay -->
    <div id="popup-overlay-edit" class="fixed inset-0 bg-black bg-opacity-25 z-40"></div>
