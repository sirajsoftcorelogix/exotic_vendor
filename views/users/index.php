            ...
            <div class="flex flex-wrap items-center gap-4">
                ...
                <div class="flex flex-wrap items-left gap-4">
                    <div class="relative flex items-left gap-2">
                        <input type="text" placeholder="Search by name, email or phone" class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" style="width: 300px; height: 37px; border-radius: 5px;">
                    </div>
                </div>
                <div class="relative">
                ...
                <div class="relative">
                    <input type="button" value="Search" style="width: 100px; height: 37px; border-radius: 5px;" class="bg-gray-800 hover:bg-gray-900 text-white font-bold rounded-lg flex items-center justify-center gap-2">
                </div>
            </div>
        </div>
        <!-- Add User Button -->
                ...
                <table class="min-w-full divide-y divide-gray-200">
					...
					?>
                                <tr class="table-content-text">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span style="width: 75px; height: 25px;" class="px-3 py-1 inline-flex items-center justify-center text-xs leading-5 font-semibold rounded-md bg-black text-white"><?= ucfirst($item['role']); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-4">
                                            <a href="?page=users&action=updateUser&id=<?= $item['id']; ?>" class="text-gray-400 hover:text-black">
