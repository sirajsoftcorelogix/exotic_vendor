                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-4 flex gap-4 shadow-sm">
                            ...
                            <div class="flex flex-col justify-center gap-1">
                                ...
                                <div><span class="text-xs text-gray-400 font-bold uppercase">Category:</span> <span class="font-semibold text-gray-800"><?php echo htmlspecialchars($category); ?></span></div>
                        ...
                        <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-5">
                            ...
                            <div>
                                ...
                                <?php if (!empty($gate_entry_date_time) && $gate_entry_date_time != "0000-00-00 00:00:00"): ?>
                                    <input type="datetime-local" name="gate_entry_date_time" value="<?php echo date('Y-m-d\TH:i', strtotime($gate_entry_date_time)); ?>" readonly class="w-full bg-gray-100 border border-gray-300 text-gray-500 py-3 px-4 rounded-lg cursor-not-allowed">
                                <?php else: ?>
                                    <input type="datetime-local" name="gate_entry_date_time" value="<?php echo date('Y-m-d\TH:i'); ?>" class="w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg focus:ring-2 focus:ring-[#d9822b] outline-none shadow-sm">
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="flex flex-col h-full bg-white p-5 rounded-xl border border-gray-200 shadow-sm gap-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="color" value="<?php echo $color; ?>" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#d9822b] outline-none font-medium shadow-sm">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-1">Item Code</label>
                                <input type="text" name="Item_code" value="<?php echo $Item_code; ?>" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#d9822b] outline-none font-medium shadow-sm">
                            </div>
                        </div>
