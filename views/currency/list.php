...
?>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { color: #333; margin-bottom: 20px; margin-top: 20px; font-size: large; }
                    ...
                    <?php foreach ($currencies as $curr): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="index.php?page=currency&action=deleteRecord&id=<?php echo $curr['id']; ?>" class="btn btn-delete" onclick="return confirm('Deactivate this currency?')">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
