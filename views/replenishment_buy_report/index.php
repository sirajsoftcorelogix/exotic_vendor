...
$sameVendorQuery = (string) ($same_vendor_query ?? '');
$queryBase = [
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
    ...
    <?php else: ?>
        <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-visible">
            ...
            <div id="replenishSelectBar" class="hidden px-5 py-3 border-b border-amber-100 bg-amber-50/70 flex-wrap items-center justify-between gap-3 text-sm" data-same-vendor-url="<?php echo $h('index.php?' . $sameVendorQuery); ?>">
...
<script src="<?php echo htmlspecialchars(base_url('assets/js/replenish_buy_report.js'), ENT_QUOTES, 'UTF-8'); ?>"></script>
