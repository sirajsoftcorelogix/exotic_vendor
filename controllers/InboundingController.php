...
class InboundingController {
    ...
    public function inbound_product_publish(){
        ...
        $stock_price_temp[0]['price_india'] = $data['data']['price_india'];
        $stock_price_temp[0]['price_india_suggested'] = $data['data']['price_india'];
        $stock_price_temp[0]['mrp_india'] = $data['data']['price_india_mrp'];
        $stock_price_temp[0]['gst'] = $data['data']['gst_rate'];
        $stock_price_temp[0]['permanent_discount'] = '';
        $stock_price_temp[0]['discount_global'] = '';
        $stock_price_temp[0]['today_global'] = '';
        $stock_price_temp[0]['discount_india'] = '';
        $stock_price_temp[0]['today_india'] = '';
        ...
        if (!empty($data['data']['var_rows'])) {
            ...
            foreach ($data['data']['var_rows'] as $key => $value) {
                ...
                $stock_price_temp[$i]['price_india'] = $value['price_india'];
                $stock_price_temp[$i]['price_india_suggested'] = $data['data']['price_india'];
                $stock_price_temp[$i]['mrp_india'] = $value['price_india_mrp'];
                $stock_price_temp[$i]['gst'] = $value['gst_rate'];
                $stock_price_temp[$i]['permanent_discount'] = '';
                $stock_price_temp[$i]['discount_global'] = '';
                $stock_price_temp[$i]['today_global'] = '';
                $stock_price_temp[$i]['discount_india'] = '';
                $stock_price_temp[$i]['today_india'] = '';
