...
function buildCommonExportSessionData(array $autoPulledData): array
{
    ...
    return [
        ...
        'exporter_name' => $firm['firm_name'] ?? 'EXOTIC INDIA ART PRIVATE LIMITED',
        'exporter_address' => $firm['address'] ?? '101, Plaza A-1, Paschim Vihar',
        'exporter_city' => $firm['city'] ?? 'New Delhi',
        'exporter_pincode' => $firm['pincode'] ?? '110063',
        'exporter_country' => 'India',
        'exporter_iec' => $firm['iec_code'] ?? '0505012345',
        'exporter_gstin' => $firm['gstin'] ?? '',
        'exporter_pan' => $firm['pan'] ?? '',
