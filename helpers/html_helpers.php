...
{ // Run this function once to populate permissions table
	global $conn;
...
function insertNotification($user_id, $title = '', $message = '', $link = '')
{
	global $conn;
	$sql = "INSERT INTO vp_notifications (user_id, title, `message`, is_read, link, created_at) VALUES (?, ?, ?, 0, ?, NOW())";
