...
final class PicklistOrderLabel
{
    ...
    public static function renderInnerHtml(array $data, ?array $config = null): string
    {
        ...
        return '<div class="pol-sheet" style="'
            ...
            . 'justify-content:flex-start;gap:' . $e((string) $gap) . 'mm;font-family:' . $e($ff) . ';'
            . 'font-size:' . $e((string) $fsOrder) . 'mm;line-height:' . $e((string) $lh) . ';color:#000;background:#fff;'
            . 'overflow:hidden;">'
            . '<div class="pol-row pol-row--order" style="flex:0 0 auto;width:100%;font-weight:700;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">'
            . 'Order ' . ($orderNumber !== '' ? $e($orderNumber) : '—')
            . '</div>'
            . '<div class="pol-row pol-row--sku" style="flex:0 0 auto;width:100%;font-weight:600;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:' . $e((string) $fsSku) . 'mm;">'
            . 'SKU ' . ($sku !== '' ? $e($sku) : '—')
            . '</div>'
            . '<div class="pol-row pol-row--barcode" style="flex:1 1 auto;width:100%;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;text-align:center;min-height:0;">'
            ...
            . ' style="max-width:100%;width:auto;height:auto;max-height:' . $e((string) $barMaxH) . 'mm;display:block;margin:0 auto;box-sizing:border-box;"></svg>'
            . '<div class="pol-barcode-caption" style="margin-top:0.1mm;font-size:' . $e((string) $fsBarcode) . 'mm;font-weight:600;line-height:1;">' . $barCodeEsc . '</div>'
            . '</div>'
            . '</div>';
    }
    ...
    private static function printScriptBlock(): string
    {
        return '<script>(function(){'
            ...
            . 'var wrap=el.parentElement;var tw=(wrap&&wrap.clientWidth)?wrap.clientWidth:320;var est=(code.length*11+28)*wf;var barW=wf;'
            . 'if(est>tw&&tw>24){barW=Math.max(1,Math.floor(wf*tw/est));}'
            . 'var showVal=el.getAttribute("data-display-value")==="1";'
            . 'JsBarcode(el,code,{format:"CODE128",displayValue:showVal,width:barW,height:parseInt(el.getAttribute("data-height-px")||"22",10)||22,margin:0,fontSize:10,background:"#ffffff",lineColor:"#000000"});}catch(e){}}}'
